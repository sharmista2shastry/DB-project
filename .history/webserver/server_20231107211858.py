...
def paywithtoken():
    ...
    try:
      ...
      params_dict = {"email":token_creation_date,"card_number":card_number,"amount":amount,"merchant_id":merchant_id,"transaction_id":1}
      cursor = g.conn.execute(text("SELECT PROCESS_TRANSACTION(:ema);"), params_dict)
