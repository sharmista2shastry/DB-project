...
def paywithtoken():
    ...
    try:
      ...
      params_dict = {"email":token_creation_date,"card_number":token_creation_date,"email":token_creation_date,"email":token_creation_date}
      cursor = g.conn.execute(text(";"), params_dict)
