...
def paywithtoken():
    ...
    isValid = False
    try:
      cursor = g.conn.execute(text("SELECT CC INTO INTERNETFLIX_CUSTOMER_DATA(CUSTOMER_NAME, CUSTOMER_ADDRESS, CUSTOMER_EMAIL, PASS_WORD) VALUES (:name, :address, :email, :password);"), params_dict)
