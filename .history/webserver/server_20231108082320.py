...
def saveandpay():
    ...
    try:
      ...
      if isValidCard:
        ...
        params_dict = {"email":email,"card_number":cardNumber,"country":country,"transaction_id":1}
        cursor = g.conn.execute(text("SELECT CREATE_AND_SAVE_TOKEN(:card_number, :email);"), params_dict)
