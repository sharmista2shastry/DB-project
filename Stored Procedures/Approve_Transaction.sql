...
DECLARE
	...
	bool3 BOOLEAN;
BEGIN
	SELECT (CD.CARDHOLDER_ID) INTO holder_id FROM CARDHOLDER_DETAILS CD WHERE CD.CARDHOLDER_NAME = $1;
	...
	FROM MERCHANTS M
	JOIN ISSUERS I ON M.MERCHANT_ID = $4 AND I.ISSUER_ID = $5;
